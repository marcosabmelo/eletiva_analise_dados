...
#---------------------------------------
# Não consegui fazer os modelos LM e RF
# Primeiro: não achei nos scripts, só tinha o SAEB_RPART
# Segundo: Copiei o código do SAEB_RPART e troquei o method por 'lm' mas
# deu erro: wrong model type for classification
#---------------------------------------
#melhor_modelo <- resamples(list(LM = SAEB_LM, RPART = SAEB_RPART, RF = SAEB_RF)) # retirei ADABOOST
#melhor_modelo
